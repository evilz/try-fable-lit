...
import { HMRToken__Subscribe_61A0B331 } from "./HMR.fs.js";
...
function LitElementUtil_isDefined(x) {
    return !(x == null);
}
        ...
        return (token) => {
            ...
            if (matchValue == null) {
                this$._hmrSub = HMRToken__Subscribe_61A0B331(token, (updatedModule) => {
                    ...
                    if (this$.shadowRoot ? updatedExport.styles : false) {
...
export class LitElementAttribute extends Attribute {
    ...
    Decorate(renderFn, mi) {
        ...
        void (pr.then((() => {
            ...
            let patternInput_1;
            if (LitElementUtil_isDefined(config_1.props)) {
                const propsValues = [];
                const propsOptions = {};
                iterate((tupledArg) => {
                    let v_1;
            ...
            if (propsOptions_1 != null) {
                const propsOptions_2 = value_2(propsOptions_1);
                Object.defineProperty(classExpr, "properties", { get: (() => propsOptions_2) });
            }
            if (LitElementUtil_isDefined(config_1.styles)) {
                Object.defineProperty(classExpr, "styles", { get: (() => toArray_1(config_1.styles)) });
            }
            ...
            let cacheName;
            if (propsOptions_1 != null) {
                const props = value_2(propsOptions_1);
                cacheName = ((((name_1(mi) + "::") + _.name) + "::") + join(", ", Object.keys(props)));
            }
            else {
            ...
            if (LitElementUtil_isDefined(config_1.styles)) {
                dummy.styles = toArray_1(config_1.styles);
            }
        })));
        return dummy;
    }
...
export function Lit_LitElement__LitElement_dispatchEvent_ZCD7099C(this$, name, bubbles, composed, cancelable) {
    ...
    }, new Event(name, opts))), (this$).dispatchEvent(arg00)));
}
...
export function Lit_LitElement__LitElement_dispatchCustomEvent_Z5A385FCE(this$, name, detail, bubbles, composed, cancelable) {
    ...
    void ((arg00 = ((opts = {
        ...
        composed: defaultArg(composed, true),
        cancelable: defaultArg(cancelable, true),
    }, new CustomEvent(name, opts))), (this$).dispatchEvent(arg00)));
}
